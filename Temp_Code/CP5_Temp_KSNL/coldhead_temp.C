void coldhead_temp()
{
  ...
  TH2F *frame = new TH2F("frame","",10, -0.04, 500, 10, 25, 46);
  //TH2F *frame = new TH2F("frame","",10, 423, 470, 10, 25, 46);
  frame->GetXaxis()->SetTitle("Days");
  frame->GetXaxis()->CenterTitle();
  frame->GetYaxis()->SetTitle("T_{Coldhead} (^{o}C)");
  ...
  for(int ll =0; ll<data; ll++)
    {
      ...
      //printf("\t%f %f %f  %f %f %f %s \n", coolar_watt_1[ll],  dip_temp_1[ll],  dip_set_1[ll],  coldhead_temp_1[ll], compressor_temp_1[ll], controller_temp_1[ll], err_1[ll] );   
  ...
  for(int ll =0; ll<range; ll++)
    {
      ...
      //printf( "%d %d %d %d %d %d \n", days_2[ll],month_2[ll],year_2[ll],hours_2[ll],min_2[ll],sec_2[ll]);
      //printf("\t%f %f %f  %f %f %f\n", coolar_watt_2[ll],  dip_temp_2[ll],  dip_set_2[ll],  coldhead_temp_2[ll], compressor_temp_2[ll], controller_temp_2[ll]);
  ...
  TGraph *gr_1 = new TGraph(data, Xaxis_1, coldhead_temp_1);
  gr_1->SetLineColor(1);
  gr_1->SetLineWidth(3);
  gr_1->Draw("l");  

  TGraph *gr_2 = new TGraph(range, Xaxis_2, coldhead_temp_2);
  gr_2->SetLineColor(2);
  gr_2->SetLineWidth(3);
  gr_2->Draw("l");  
  ...
  TLatex *tex112 = new TLatex(0.31,0.21,"Stable temp. (33.3 - 35.2)^{o}C");
  tex112->SetNDC();
  ...
  TLatex *tex1122 = new TLatex(0.13,0.67,"Stable temp. (36.0 - 38.3)^{o}C");
  tex1122->SetNDC();
