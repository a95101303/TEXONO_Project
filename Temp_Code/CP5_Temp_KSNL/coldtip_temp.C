void coldtip_temp()
{
  ...
  TH2F *frame = new TH2F("frame","",10, 0, 500, 10, -205, -185); 
  //TH2F *frame = new TH2F("frame","",10, 423.0, 470, 10, -205, -185);
  frame->GetXaxis()->SetTitle("Days");
  frame->GetXaxis()->CenterTitle();
  frame->GetYaxis()->SetTitle("Coldtip temp (^{o}C)");
  ...
  TGraph *gr_1 = new TGraph(data, Xaxis_1, dip_temp_1);
  gr_1->SetLineColor(1);
  gr_1->SetLineWidth(3);
  gr_1->Draw("l");  
  
  TGraph *gr_2 = new TGraph(range, Xaxis_2, dip_temp_2);
  gr_2->SetLineColor(2);
  gr_2->SetLineWidth(3);
  gr_2->Draw("l");  
