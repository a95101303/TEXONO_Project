...
void Hist_SetLimit_Plot_v2_Possion_KS_Run_chie1(int Index, int Simulated_Event_Number, int Index_Sigma, double Sigma_SI)
{
...
*/
    ...
    for(int kkk=0; kkk<Simulated_Event_Number; kkk++)
    {
        ...
        //cout << "1: " << endl;
        double C = fdsigma_dT_ER_New(1,300,1,0.07);
        double A = Slope_A(1,3,2,4);
        cout << "A: " << A << endl;
        double B = Constant_B(A,2,4);//==Constant_B(A,1,3);
        cout << "B: " << B << endl;
        double Y = Expected_Y(1.5,A,B);
        cout << "Y: " << Y << endl;
        /*
        cout << "===================================" << endl;
