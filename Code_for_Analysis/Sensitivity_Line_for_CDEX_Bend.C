...
void Sensitivity_Line_for_CDEX_Bend()//CDEX:Threshold=160eV, TEXONO:Threshold=200eV
{
...
for(int kkk=11;kkk<12;kkk++)
    {
        ...
        cout << "kkk: " << kkk << endl;
        double Mass=0;
    for(int FILE=11; FILE<14; FILE++){//Open1
        ...
        TFile *ROOT_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/1_CDEX_Bent_MAT/%sGeV/%i_STS_Bent.root",Mass_Point[Mass_INT].c_str(),FILE));
        ...
        for(int i=0;i<reso_T;i++)
        {
            ...
            if(T_QF_Original_Bef_Array[i]>0.16 and T_QF_Original_Bef_Array[i]<0.185)//>Threshold
            {RecoilX_Event_Original_M1  = RecoilX_Event_Original_M1 + Factor1_Original_Bef_Array[i];}
            if(T_QF_Original_Aft_Array[i]>0.16 and T_QF_Original_Aft_Array[i]<0.185)//>Threshold
        ...
        if(Take_Plot==1){
        c3->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/1_CDEX_Bent_MAT/%sGeV/Recoil_Spectrum/%s_%i_STS_Bent.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE));
            cout << "=================================================================================" << endl;
        }
        ...
        {
            char fout_name[300];
            sprintf(fout_name,Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/1_CDEX_Bent_MAT/%sGeV/%s_STS.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
            TFile *fout=new TFile(fout_name,"recreate");
            Threshold_Plot_4->Write();
            c4->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/1_CDEX_Bent_MAT/%sGeV/%s_STS.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
        }
    }
}
