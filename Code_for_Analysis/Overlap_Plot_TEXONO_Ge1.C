...
void Overlap_Plot_TEXONO_Ge1()//CDEX:Threshold=160eV, TEXONO:Threshold=200eV
{
...
for(int kkk=0;kkk<1;kkk++)
    {
        ...
        double Mass=0;
    for(int FILE=0; FILE<26; FILE++){//Open1
        string path = Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/%i_STS_2.root",Mass_Point[Mass_INT].c_str(),FILE);
        //cout << "path: " << path << endl;
        ifstream fin(path);
        if(fin.is_open() and Check_ZERO==0){//Open
        //===============Input the ROOTFILE for all==============
        TFile *ROOT_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/%i_STS_2.root",Mass_Point[Mass_INT].c_str(),FILE));
        ...
        c3->SetLogx();
                cout << "=================================================================================" << endl;
            char fout_name1[300];
            sprintf(fout_name1,Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/Recoil_Spectrum/%s_%i_2.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE));
        ...
        if(Take_Plot==1){
        c3->Print(Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/Recoil_Spectrum/%s_%i_2.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE));
            cout << "=================================================================================" << endl;
        }
        ...
        {
            char fout_name[300];
            sprintf(fout_name,Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/%s_Line_STS_2.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
            TFile *fout=new TFile(fout_name,"recreate");
            Threshold_Plot_2->Write();
            c4->Print(Form("/Users/yehchihhsiang/Desktop/Analysis/CDEX_Analysis_method/Codes/2_TEXONO_Flux/%sGeV/%s_Line_STS_2.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
        }
    }
}
