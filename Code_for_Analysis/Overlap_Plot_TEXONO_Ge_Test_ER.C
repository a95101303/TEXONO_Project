...
for(int kkk=36;kkk<37;kkk++)//for(int kkk=31;kkk<41;kkk++)
{
    ...
    */
    ...
    for(int i=0;i<reso_T;i++)
    {
        ...
        //cout << "===========================================================================";
        if(T_QF_Original_Aft_Array[i]>0.175 and T_QF_Original_Aft_Array[i]<0.225)
        {
        ...
        RecoilX_Event_Original_M1  = (RecoilX_Event_Original_M1)/(double(Bin_Number));
