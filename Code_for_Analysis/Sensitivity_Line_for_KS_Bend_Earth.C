...
void Sensitivity_Line_for_KS_Bend_Earth()//CDEX:Threshold=160eV, TEXONO:Threshold=200eV
{
...
for(int kkk=9;kkk<10;kkk++)//Straight or bending
    {
        ...
        cout << "kkk: " << kkk << endl;
        double Mass=0;
    for(int FILE=20; FILE<26; FILE++){//Open1
        cout << "FILE: " << FILE << endl;
        string path = Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/%i_STS_Bent%s.root",Mass_Point[Mass_INT].c_str(),FILE,Bent_or_Not_Type[Bent_Type].c_str());
        //cout << "path: " << path << endl;
        ifstream fin(path);
        if(fin.is_open()){//Open
            cout << "FILE1: " << FILE << endl;
        //===============Input the ROOTFILE for all==============
    TFile *ROOT_FILE  = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/%i_STS_Bent%s.root",Mass_Point[Mass_INT].c_str(),FILE,Bent_or_Not_Type[Bent_Type].c_str()));
    ...
    TFile *ROOT_FILE1 = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/%i_STS_Bent%s.root",Mass_Point[Mass_INT].c_str(),FILE,Bent_or_Not_Type[Bent_Type].c_str()));
        ...
        c3->SetLogx();
                cout << "=================================================================================" << endl;
            char fout_name1[300];
            sprintf(fout_name1,Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/Recoil_Spectrum/%s_%i_STS_Bent%s.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE,Bent_or_Not_Type[Bent_Type].c_str()));
        ...
        if(Take_Plot==1){
        c3->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/Recoil_Spectrum/%s_%i_STS_Bent%s.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE,Bent_or_Not_Type[Bent_Type].c_str()));
            cout << "=================================================================================" << endl;
        ...
        Threshold_Plot_4->GetYaxis()->SetRangeUser(1e-42,1e-26);
        ...
        {
            char fout_name[300];
            sprintf(fout_name,Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/%s_STS%s.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),Bent_or_Not_Type[Bent_Type].c_str()));
            TFile *fout=new TFile(fout_name,"recreate");
            Threshold_Plot_4->Write();
            c4->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_CRESST_Bent_MAT/%sGeV/%s_STS%s.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),Bent_or_Not_Type[Bent_Type].c_str()));
        }
    }
}
