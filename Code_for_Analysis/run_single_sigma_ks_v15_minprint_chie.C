...
void run_single_sigma_ks_v15_minprint_chie(double mx=2.0)
{
    ...
    //m_A'=0
    //gROOT->ProcessLine(Form("Hist_SetLimit_Plot_v2_Possion_KS_Run_chie(0,%i,100,1e-24)",Event_Number));//V
    gROOT->ProcessLine(Form("Hist_SetLimit_Plot_v2_Possion_KS_Run_chie(1,%i,100,2e-24)",Event_Number));
    //gROOT->ProcessLine(Form("Hist_SetLimit_Plot_v2_Possion_KS_Run_chie(2,%i,100,1e-30)",Event_Number));
    //m_A'=1e6
