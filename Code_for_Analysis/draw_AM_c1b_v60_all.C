...
void draw_AM_c1b_v60_all()
{
  ...
  TFile *fin=new TFile("/Users/ms08962476/Report/AS_GeIA/Analysis/CDEX_Analysis_method/1.root");
  ...
  TH2F *frame = new TH2F("frame","",100,1,30,100,1e-43,1e-33);
//  TH2F *frame = new TH2F("frame","",100,3.0,28,100,4e-42,9e-40);
  ...
  tex = new TLatex(4.0,6.15e-38,"DAMA/LIBRA 5-#sigma,");
  tex->SetTextFont(42);
