...
void Overlap_Plot_TEXONO_Ge_Bent()//CDEX:Threshold=160eV, TEXONO:Threshold=200eV
{
...
for(int kkk=0;kkk<1;kkk++)
    {
        ...
        double Mass=0;
    for(int FILE=1; FILE<6; FILE++){//Open1
        string path = Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/%i_STS_Bent.root",Mass_Point[Mass_INT].c_str(),FILE);
        //cout << "path: " << path << endl;
        ifstream fin(path);
        if(fin.is_open() and Check_ZERO==0){//Open
        //===============Input the ROOTFILE for all==============
        TFile *ROOT_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/%i_STS_Bent.root",Mass_Point[Mass_INT].c_str(),FILE));
        ...
        c3->SetLogx();
                cout << "=================================================================================" << endl;
            char fout_name1[300];
            sprintf(fout_name1,Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/Recoil_Spectrum/%s_%i_STS_Bent.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE));
        ...
        if(Take_Plot==1){
        c3->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/Recoil_Spectrum/%s_%i_STS_Bent.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str(),FILE));
            cout << "=================================================================================" << endl;
        }
        ...
        {
            char fout_name[300];
            sprintf(fout_name,Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/%s_Line_STS_Bent.root",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
            TFile *fout=new TFile(fout_name,"recreate");
            Threshold_Plot_2->Write();
            c4->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/2_TEXONO_Bent/%sGeV/%s_Line_STS_Bent.pdf",Mass_Point[Mass_INT].c_str(),Type_of_Model[Type_of_Model_INT].c_str()));
        }
    }
}
