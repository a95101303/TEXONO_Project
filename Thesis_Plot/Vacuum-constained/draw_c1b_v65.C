...
//TEXONO
    ...
    TEXONO_Down->SetFillColor(kYellow-7);
    ...
    texono_real->SetFillColor(kYellow-4);
    texono_real->SetFillStyle(3144);
    //texono_real->Draw("f");
    
    TLatex *tex11 = new TLatex(0.8,1e-38,"TEXONO(NU)");
    tex11->SetTextFont(42);
    tex11->SetTextSize(0.04);
    tex11->SetLineWidth(2);
    tex11->SetTextColor(kYellow-4);
    //tex11->Draw();
...
//
  ...
  tex = new TLatex(4.0,8e-42,"CoGeNT 90%");
  tex->SetTextFont(42);
  tex->SetTextSize(0.04);
...
// nlimit_cjpl_real_np2->Draw("c");
 ...
 TGraph *c1b_migdal_adjust = new TGraph("c1b_migdal_adjust.txt","%lg  %lg");
