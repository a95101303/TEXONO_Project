...
void Overlap_Plot_recoil_spectrum_ex()//CDEX:Threshold=160eV, TEXONO:Threshold=200eV
{
        ...
        //==============Mass==============//
        TFile *ROOT_FILE1 = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/Thesis_Plot/Spectrum_Ex/NU.root"));
        TGraph *NU = (TGraph*)ROOT_FILE1->Get("Graph");
    
        NU->GetXaxis()->SetTitle("Energy[keVee]");
        NU->GetYaxis()->SetTitle("Count(cpkkd)");
        ...
        TFile *ROOT_FILE2 = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/Thesis_Plot/Spectrum_Ex/MD.root"));
        TGraph *MD = (TGraph*)ROOT_FILE2->Get("Graph");
        MD->SetLineColor(3);
        MD->SetMarkerColor(3);
        TFile *ROOT_FILE3 = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/Thesis_Plot/Spectrum_Ex/BR.root"));
        ...
        leg->AddEntry(NU,"Nuclear Recoil","l");
        leg->AddEntry(MD,"Midgal Effect","l");
        leg->AddEntry(BR,"Bremsstrahlung","l");
