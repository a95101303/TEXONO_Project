...
//  TH2F *frame = new TH2F("frame","",100,3.0,200,100,5e-43,1e-39);
  TH2F *frame = new TH2F("frame","",100,0.05,2,100,1e-32,1e-22);
...
*/
     ...
     texono_real_Migdal_Bend->SetLineWidth(5);
     texono_real_Migdal_Bend->Draw("lsame");

    TLatex *tex20;
    tex20 = new TLatex(0.05,5e-27,"MD: TEXONO(MAT:Real)");
    ...
    TLatex *tex6;
    tex6 = new TLatex(0.06,2e-33,"MD: TEXONO(CAR:Tradition)");
    tex6->SetTextFont(42);
