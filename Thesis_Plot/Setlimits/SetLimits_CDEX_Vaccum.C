...
//==================================================================================================
    ...
    TLatex *tex_CDEX_NU = new TLatex(2,3e-40,"CDEX-1b(NU)");
    tex_CDEX_NU->SetTextFont(42);
    tex_CDEX_NU->SetTextSize(0.04);
    tex_CDEX_NU->SetLineWidth(2);
    tex_CDEX_NU->SetTextColor(kOrange+10);
    tex_CDEX_NU->SetTextAngle(-25);
    tex_CDEX_NU->Draw();
    ...
    tex_CDEX_MD->Draw();
     ...
     TGraph *cdex_vacuum_Brem = new TGraph(); cdex_vacuum_Brem->SetName("cdex_vacuum_Brem");

     for(int i=0;i<16;i++)
     {
         cout << "CDEX_real_Brem_Lower_Original[i][0]: " << CDEX_real_Brem_Lower_Original[i][0] << endl;
         cout << "CDEX_real_Brem_Lower_Original[i][1]: " << CDEX_real_Brem_Lower_Original[i][1] << endl;

         cdex_vacuum_Brem->SetPoint((i), CDEX_real_Brem_Lower_Original[i][0],CDEX_real_Brem_Lower_Original[i][1]);
     }
     ...
     TLatex *tex_CDEX_BR;
     tex_CDEX_BR = new TLatex(0.05,1e-29,"CDEX-1b(Brem)");
     tex_CDEX_BR->SetTextFont(42);
     tex_CDEX_BR->SetTextSize(0.04);
     tex_CDEX_BR->SetLineWidth(2);
     tex_CDEX_BR->SetTextColor(kOrange+10);
     tex_CDEX_BR->SetTextAngle(-15);
     tex_CDEX_BR->Draw();
    //============================
    ...
    texono_real_Migdal->SetFillColor(kOrange+10);
...
//===============================================================
  ...
  //pave->Draw();
    ...
    tex = new TLatex(3.6,3.5e-40,"CoGeNT");
  tex->SetTextFont(42);
  tex->SetTextSize(0.04);
