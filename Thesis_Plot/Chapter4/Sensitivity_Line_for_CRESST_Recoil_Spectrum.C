...
void Sensitivity_Line_for_CRESST_Recoil_Spectrum()
{
    ...
    for(int FILE=49; FILE<50; FILE++){
        ...
        TFile *The_Vacuum_Case_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/4_CRESST_Flux/2GeV/Recoil_Spectrum/NU_%i_STS_Bent.root",FILE));
            ...
            The_Vacuum_Case->SetMarkerColor(2);
            The_Vacuum_Case->SetLineStyle(1);
            The_Vacuum_Case->GetXaxis()->SetLimits(0,1);
            The_Vacuum_Case->GetYaxis()->SetRangeUser(1e7,1e10);
        ...
        TFile *The_Straight_Case_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/4_CRESST_Flux/2GeV/Recoil_Spectrum/NU_%i_STS_Bent_Comparison.root",FILE));
            ...
            The_Straight_Case->SetMarkerColor(3);
        ...
        TFile *The_Bending_Case_FILE = TFile::Open(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/4_CRESST_Flux/2GeV/Recoil_Spectrum/NU_%i_STS_Bent.root",FILE));
            ...
            The_Bending_Case->SetMarkerColor(4);
    ...
    cout << "YES4" << endl;
            ...
            leg->AddEntry(The_Straight_Case,"The MAT^{N}(CAT) Case","l");
            leg->AddEntry(The_Bending_Case,"The MAT^{S} Case","l");
        ...
        c3->Print(Form("/Users/yehchihhsiang/Desktop/GITHUB_TEXONO/Thesis_Plot/Chapter4/All_%i_2GeV_STS.pdf",FILE));
    }
}
